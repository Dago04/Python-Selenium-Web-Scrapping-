...
if __name__ == '__main__':
    ...
    browser = uc.Chrome()
    email = 'dagoscr@gmail.com'
    password = 'P@m3la&Z3reth.99'

    browser.get('https://accounts.google.com/InteractiveLogin/identifier?elo=1&ifkv=AVQVeywwecDTyhmaYWHxBg2wT1LUZdmhjvpEfgthDdK-6iqwBFsZgd0yZW8OB9AP5WqIusgyUt7ZCg&theme=glif&flowName=GlifWebSignIn&flowEntry=ServiceLogin')
